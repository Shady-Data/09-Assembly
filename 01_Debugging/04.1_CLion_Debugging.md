...
We are going to continue to step in until we notice something weird of unexpected with the values in the debugging window. Our code window will display some information too. Below is a screenshot of us having stepped in 6 times... thus i is 5. Notice how it displays the itteration for us. This makes it slightly easier to know how many times you stepped in without having to look at the debug window. 
