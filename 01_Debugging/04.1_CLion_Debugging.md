...
**Note:** Our solution should have been to change i < a to i <= a

Step through the next issue and see if you can determine the problem. Then fix it! (The problem is fairly easy, but step through it anyway and watch what happens to the values.)
