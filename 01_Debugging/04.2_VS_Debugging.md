...
Engage debugging mode by first ensuring the build type and then click the build+run button. Refer to 04.0 for how the toolbar should look. 


## Running in Debugging Mode

Engage debugging mode by first ensuring the build type is debug, and then click the build+run button.
